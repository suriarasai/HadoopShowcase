object LearningScala {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(66); 
  ...
  val hello: String = "Hello BA BEAD!";System.out.println("""hello  : String = """ + $show(hello ));$skip(17); 
  ...
  println(f"Zero padding on the left: $numberOne%05d");$skip(168); 
                                                  
  // Substituting in variables:
  println("I can use the s prefix to use variables like $numberOne $truth $letterA");$skip(149); 
  // Substituting expressions (with curly brackets):
  println("The s prefix isn't limited to variables; I can include any expression. Like ${1+2}");$skip(163); 
